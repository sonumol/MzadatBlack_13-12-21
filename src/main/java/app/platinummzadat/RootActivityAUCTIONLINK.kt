...
class RootActivityAUCTIONLINK : MzActivity(),MzFragmentListener, RootContract.View {
    ...
    override fun onSelectNavItem(navItem: MzNav) {
        ...
        when (navItem) {
            AUCTIONS -> {
                ...
                val intent=Intent(applicationContext, RootActivityAUCTIONLINK::class.java)
                startActivity(intent)
            }
            DIRECT_PURCHASE -> {
...
//        val name:String =radioButton.text.toString()
        ...
        editor.apply()
        editor.commit()
//        Toast.makeText(MApp.applicationContext(),"ff"+international,Toast.LENGTH_LONG)
    }
...
//                .setTitle("")
//                .setMessage(R.string.sure_exit_now)
//                .setPositiveButton(R.string.exit) { dialog, whichButton ->

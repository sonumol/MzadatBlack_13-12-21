package app.platinummzadat.qa.views.root.Buyingauction
...
//            Toast.makeText(MApp.applicationContext(),""+ type ,Toast.LENGTH_LONG).show()
    ...
    override fun showData(dataSet: ArrayList<AuctionItemModel>) {
        ...
        val sharedPreferences: SharedPreferences= activity!!.getSharedPreferences("item.listing_count1",
            Context.MODE_PRIVATE)
//        val sharedIdValue = sharedPreferences.getInt("id_key","")
        val listing_count = sharedPreferences.getInt("item.listing_count1",0)

...
class ProductAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        VH(
            DataBindingUtil.inflate(
                ...
                if (AUCTION_ADAPTER_LIST == type) R.layout.item_auction_linear else R.layout.item_auction_linear,
                parent,
                false
            )
        )
    ...
    inner class VH(val itemBinding: ViewDataBinding) :
        ...
        fun bindData(data: AuctionItemModel) {
            ...
            if (app.platinummzadat.qa.views.root.Buyingauction.AUCTION_ADAPTER_LIST == type) {
...
//                    btnBidNow.visibility = View.GONE
